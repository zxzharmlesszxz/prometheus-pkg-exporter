GO_MODULE ?= github.com/zxzharmlesszxz/prometheus-pkg-exporter
...
PROJECT_NAME ?= prometheus-pkg-exporter
PROJECT_DESC ?= Prometheus Pkg Exporter
FEATURE_NAME ?= pkg
METRIC_NAMESPACE ?= pkg_exporter
DEFAULT_PORT ?= :9888
FEATURE_CONFIG_FILE ?= prometheus-pkg-exporter.yml
...
DOCKER_SMOKE_METRIC ?= $(METRIC_NAMESPACE)_upgrade_metrics_valid
